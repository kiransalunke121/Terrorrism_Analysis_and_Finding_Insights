...
def create_app_ui():
  ...
  html.H1('Terrorism Analysis with Insights',style={'color':'red','margin':'0px','padding':'20px'},id='Main_title'),
  ...
  html.Div(id = "graph-object", children ="Graph will be shown here")
   ...
   , style={'text-align':'center','color':'red','background-color':'black','margin-top':'0px'}
    )
